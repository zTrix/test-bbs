...
int do_com_menu()
{
    char menus[menust][15]= {"0-返回","1-退出游戏","2-改名字", "3-玩家列表", "4-改话题", "5-设置房间", "6-踢玩家", "7-发言权", "8-交换位置", "9-开始游戏"};
...
quitgame2:
    ...
    if (toupper(buf3[0])=='Y') {
        ...
        mail_file(getCurrentUser()->userid, buf, getCurrentUser()->userid, buf2, BBSPOST_MOVE, NULL, 0);
    }
