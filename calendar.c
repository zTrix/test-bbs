...
int mail_all_diary()
{
    ...
    *fname++ = '/';
    ...
    mail_file(getCurrentUser()->userid, mailfile, getCurrentUser()->userid, title, BBSPOST_MOVE, NULL, 0);
            ...
            case 'm':
                ...
                if (stat(buf, &st)!=-1) {
                    ...
                    if (toupper(title[0])=='Y') {
                        ...
                        mail_file(getCurrentUser()->userid, buf2, getCurrentUser()->userid, title, BBSPOST_MOVE, NULL, 0);
                    }
                }
                break;
            case 'M':
